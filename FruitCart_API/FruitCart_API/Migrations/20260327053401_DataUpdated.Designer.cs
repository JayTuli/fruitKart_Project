...
namespace FruitCart_API.Migrations
{
    ...
    [Migration("20260327053401_DataUpdated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FruitCart_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FruitCart_API.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FruitCart_API.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("FruitCart_API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FruitCart_API.Models.OrderDetail", b =>
                {
                    b.HasOne("FruitCart_API.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FruitCart_API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("FruitCart_API.Models.OrderHeader", b =>
                {
                    b.HasOne("FruitCart_API.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FruitCart_API.Models.ApplicationUser", null)
                        .WithMany()
